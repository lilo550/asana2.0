  ...
  return (
    <main className="bg-highlight-light">
      ...
      <section className="mx-auto max-w-5xl px-4 pb-16 pt-20 text-center">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-2xl text-primary/70">
      ...
      <section className="mx-auto max-w-2xl px-4 pb-20">
        <blockquote className="rounded-xl bg-primary p-8 text-center shadow-sm">
          <p className="text-white text-base">
            „Ich habe zum ersten Mal wirklich den Überblick über alle laufenden Projekte."
          </p>
          <footer className="mt-3 text-base font-medium text-white/80">— Mira, Team-Lead</footer>
        </blockquote>
      </section>
...
function FeatureCard({ title, description, visual }) {
  return (
    <div className="rounded-xl border border-primary/10 bg-white p-5 shadow-sm">
      ...
      <p className="mt-1 text-base text-primary/70">{description}</p>
    </div>
  );
}
...
function EventPreview() {
  return (
    <div className="rounded-lg border border-primary/10 bg-highlight p-3">
      <p className="text-base font-semibold text-primary">Produktlaunch Q3</p>
      <div className="mt-2 flex flex-wrap gap-1.5">
        <span className="rounded bg-white px-2 py-0.5 text-xs text-primary/70 shadow-sm">
          Marketingkampagne
        </span>
        <span className="rounded bg-white px-2 py-0.5 text-xs text-primary/70 shadow-sm">
          Website Relaunch
...
function EditPreview() {
  return (
    <div className="rounded-lg border border-primary/10 bg-highlight p-3">
      ...
      <span className="mt-2 inline-block rounded bg-primary px-2 py-0.5 text-xs text-white">
        Speichern
      </span>
    </div>
  );
...
function ConfirmPreview() {
  return (
    <div className="rounded-lg border border-primary/10 bg-highlight p-3 text-center">
      <p className="text-base font-medium text-primary">„Event" löschen?</p>
      <div className="mt-2 flex justify-center gap-1.5">
        <span className="rounded bg-white px-2 py-0.5 text-xs text-primary/70 shadow-sm">
          Abbrechen
        </span>
        <span className="rounded bg-secondary px-2 py-0.5 text-xs text-white">Löschen</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="rounded-lg border border-primary/10 bg-highlight p-3">
      <div className="flex items-center gap-2">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-secondary text-base">
          <FaBell />
        </span>
        <p className="text-base text-primary/80">Fällig in 3 Tagen</p>
      </div>
    </div>
  );
}