  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-xl rounded-xl border border-primary/10 bg-white p-6 shadow-sm">
        <h1 className="text-4xl font-bold text-primary">Registrieren</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-3">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-md bg-white-light border border-primary/20 px-3 py-2 text-sm focus:border-secondary focus:outline-none"
            />
          </div>
          <div>
